...
export function GymScheduleManager({ gymId, gymName }: GymScheduleManagerProps) {
  const { schedules, isLoading, createSchedule, updateSchedule, deleteSchedule } = useGymSchedules(gymId);
    ...
    <Card>
      <CardHeader className="flex flex-row items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <CardTitle className="text-lg">Weekly Schedule - {gymName}</CardTitle>
        </div>
